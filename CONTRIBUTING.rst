...
.. _GitHub: https://github.com/garryod/degradation_eda/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/garryod/degradation_eda.git
    $ cd degradation_eda
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/garryod/degradation_eda/releases
